...
{
    public class Inky : IRenderable, ICollidable
    {
        ...
        {
            g.FillEllipse(new SolidBrush(Color.Cyan), new Rectangle(X + Width / 8, Y, (Width * 3) / 4, Height / 2));
            g.FillRectangle(new SolidBrush(Color.Cyan), new Rectangle(X + Width / 8, Y + Height / 4, (Width * 3) / 4, (Height * 5) / 8));
            g.FillEllipse(new SolidBrush(Color.Cyan), new Rectangle(X + Width / 8, Y + (Height * 3) / 4, Width / 4, Height / 4));
            g.FillEllipse(new SolidBrush(Color.Cyan), new Rectangle(X + Width / 4, Y + (Height * 3) / 4, Width * 6 / 25, Height * 6 / 25));
            g.FillEllipse(new SolidBrush(Color.Cyan), new Rectangle(X + Width * 3 / 8, Y + (Height * 3) / 4, Width / 4, Height / 4));
            g.FillEllipse(new SolidBrush(Color.Cyan), new Rectangle(X + Width / 2, Y + (Height * 3) / 4, Width * 6 / 25, Height * 6 / 25));
            g.FillEllipse(new SolidBrush(Color.Cyan), new Rectangle(X + Width * 5 / 8, Y + (Height * 3) / 4, Width / 4, Height / 4));
